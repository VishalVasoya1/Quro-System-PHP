...
<head>
    ...
    <title>Employee Pending Complain</title>
    <!-- plugins:css -->
    ...
    ?>
            ...
            ?>
                    <div class="page-header">
                        <h3 class="page-title">Employee Pending Complain</h3>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#">Complain</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Employee Pending Complain</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="row">
            ...
            if(isset($_SESSION['aname']) && isset($_SESSION['aid']) && isset($_SESSION['aemail']) && isset($_SESSION['aimg']))
            {
                $q1="select * from complain where type='EMPLOYEE' and rstatus='0'";
