...
{$out='';
        ...
        while($row1 = mysqli_fetch_array($result))
        {
            ...
            $method = $row1['bankname'];
            $tnxdate = $row1['txndate'];
            $mid = $row1['banktxnid'];
...
<head>
    ...
    <title>Today Online Collection</title>
...
<div class="page-header">
                        <h3 class="page-title">Today Online Collections</h3>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#">Collections</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Online Collections</li>
                            </ol>
                        </nav>
                    </div>
