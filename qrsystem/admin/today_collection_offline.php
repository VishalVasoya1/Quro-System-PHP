...
<head>
    ...
    <title>Offline Order Collection</title>
    <!-- plugins:css -->
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="page-header">
                        <h3 class="page-title">Today Payment Collections</h3>
                    ...
                    <div class="row">
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            <?php
                                        $q2="select * from orders where payment_method='COD' and status='Done' order by dop desc";
                                        if($r2=mysqli_query($conn,$q2))
                                        {
                                            while($n1=mysqli_fetch_assoc($r2))
                                            {
                                                ...
                                                echo '<td>'.$n1['dop'].'</td>';
                                                echo '<td><a href="order_success.php?fcode='.$n1['order_id'].'" class="btn btn-sm btn-inverse-primary mr-2">Invoice</a>
                                                <a href="order_details.php?oid='.$n1['order_id'].'" class="btn btn-sm btn-inverse-danger mr-2">View</a></td>';
                                            }
                                                echo '
                            ...
                            <a href="view_product.php" class="btn btn-sm btn-inverse-primary mr-2">Go To Shopping</a>
                        </div>';
