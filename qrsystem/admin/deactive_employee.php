...
if(isset($_SESSION['aname']) && isset($_SESSION['aid']) && isset($_SESSION['aemail']) && isset($_SESSION['aimg']))
{
  ...
  {
    $eid=$_POST['eid'];
    $q1="update employee set account_status=1 where eid='$eid'";
  ...
  {
    $eid=$_POST['eid'];
    $q1="update employee set account_status=0 where eid='$eid'";
    if($r1=mysqli_query($conn,$q1))
    {
    ...
    ?> 
       <div class="main-panel">
          ...
          <div class="page-header">
              <h3 class="page-title">DeActive Employees</h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="#">Employees</a></li>
                  <li class="breadcrumb-item active" aria-current="page">DeActive Employees</li>
                </ol>
              </nav>
            </div>
            <div class="row">
        ...
        <!-- partial -->
    <?php
    $q1="select * from employee where account_status='0'";
    if($r1=mysqli_query($conn,$q1))
    {
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-3">
                        <div class="wrapper d-flex justify-content-end">
                          <button type="button" class="btn btn-sm btn-inverse-primary mr-2"><a style="text-decoration:none;color:white;" href="update_employee.php?eid='.$num['eid'].'">Update</a></button>
                          <button type="button" class="btn btn-sm btn-inverse-danger mr-2"><a style="text-decoration:none;color:white;" href="view_employee.php?eid='.$num['eid'].'">View</a></button>
                          <button type="button" class="btn btn-sm btn-inverse-danger mr-2"><a style="text-decoration:none;color:white;" href="delete_employee.php?eid='.$num['eid'].'">Remove</a></button>
                        </div>
                      </div>
                    </div>
                  </div>
