...
if(isset($_SESSION['aname']) && isset($_SESSION['aid']) && isset($_SESSION['aemail']) && isset($_SESSION['aimg']))
{
    if(isset($_POST['submit']))
    {
        ...
        $npass=$_POST['npass'];
        $ncpass=$_POST['ncpass'];
        $q2="select * from admin where aid='".$_SESSION['aid']."'";
        if($r2=mysqli_query($conn,$q2))
        {
            while($num1=mysqli_fetch_assoc($r2))
            {
                ...
                if($pass == $opass)
                {
                    if($ncpass == $npass)
                    {
                        $q3="update admin set apass='$npass' where aid='$aid'";
          ...
          <div class="row w-100">
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-transparent text-left p-5 text-center">
                <img src="../../images/admin/profile/<?php echo $_SESSION['aimg']; ?>" style="height:135px;width:135px;border-radius: 50%;" class="lock-profile-img" alt="img">
