            ...
            <div class="wrapper border-top">
                <div class="card-body">
                    <div class="row">
                            ...
                            <div class="image-grouped ml-auto">
                                <div class="image-grouped ml-auto">
                                        ...
                                        echo '<button type="submit" name="active"
                                            class="btn btn-sm btn-inverse-success mr-2" disabled>Active</button>';
                                        }
                                        else
                                        {
                                        echo '<button type="submit" name="deactive"
                                            class="btn btn-sm btn-inverse-danger mr-2" disabled>DeActive</button>';
                                        }
                                        echo '
                       ...
                       ' ;?>
                        <?php
                        if($num['psdetail']=="1" && $num['pfinalstatus']=="1")
                        {
                          ?>
