...
if(isset($_SESSION['aname']) && isset($_SESSION['aid']) && isset($_SESSION['aemail']) && isset($_SESSION['aimg']))
{
  ...
  {
    $crid=$_POST['crid'];
    header("location:delete_user_complain_replay.php?crid=$crid");
  }
}
    ...
    ?>
            ...
            ?>
                    <div class="page-header">
                        <h3 class="page-title">View User Complain</h3>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#">Complain</a></li>
                                <li class="breadcrumb-item active" aria-current="page">View User Complain</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="row">
