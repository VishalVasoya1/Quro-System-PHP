          ...
          <div class="card">
            <div class="card-body">
              <div class="d-flex mb-4 text-dark">
                ...
                <h5 class="font-weight-semibold"><font color="red">'. $order_id.'</font> ||<font color="green">'.$pname.'</font></h5>
              </div>
              <div class="row">
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-lg" id="psize" name="psize" value="<?php echo $size?>"
                                                required disabled>
                                        </div>

                                        <div class="form-group">
                                            <label for="gender"> Color</label>
                                            <input class="form-control form-control-lg" id="pcolor" name="pcolor" value="<?php echo $pcolor?>"
                                                required disabled>
