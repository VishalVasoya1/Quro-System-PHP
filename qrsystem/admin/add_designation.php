...
if(isset($_SESSION['aname']) && isset($_SESSION['aid']) && isset($_SESSION['aemail']) && isset($_SESSION['aimg']))
{
    if(isset($_POST['submit']))
    {
        ...
        $q11="select * from designation where dname='$dname'";
        if($r11=mysqli_query($conn,$q11))
        {
            ...
            {
                  $q2="insert into designation values('$new','$dname','$vacancy',current_timestamp())";
                ...
                {
                    $error="Designation Not Inserted SuccesFully";
                }
            }
        }
    }
          ...
          <?php 
            ...
            <div class="row">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Add Employee Designation</h4>
                    <form class="forms-sample" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="vacancy" name="vacancy" placeholder="Total Vacancy">
                      </div>
