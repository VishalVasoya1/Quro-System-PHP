...
<head>
    ...
    <title>View User Suggestion</title>
    <!-- plugins:css -->
    ...
    ?>
            ...
            ?>
                    <div class="page-header">
                        <h3 class="page-title">View User Suggestion</h3>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#">Suggestion</a></li>
                                <li class="breadcrumb-item active" aria-current="page">User Suggestion</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="row">
            ...
            if(isset($_SESSION['aname']) && isset($_SESSION['aid']) && isset($_SESSION['aemail']) && isset($_SESSION['aimg']))
            {
                $q1="select * from suggestion where desig='USER'";
                if($r1=mysqli_query($conn,$q1))
                {
                    while($num=mysqli_fetch_assoc($r1))
                    {
                        ...
                        <div class="card">
                          <div class="card-body">
                            <h4 class="card-title"><font style="color:green">'.$num['name'].'</font>  |  '.$num['stamp'].' | <font color="red">' .$num['sid'].'</font></h4>
