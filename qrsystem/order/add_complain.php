...
if(isset($_SESSION['ename']) && isset($_SESSION['eid']) && isset($_SESSION['eemail']) && isset($_SESSION['eimg']))
{
    if(isset($_POST['submit']))
    {
        ...
        if(!$file1 == ""){
            move_uploaded_file($temp,"../../images/employee/complain/$file1");
        }
        $q2="insert into complain values('$new','$stitle','$desc','','$file1','$uid','$uname','$uemail','$mno','EMPLOYEE','0',current_timestamp())";
