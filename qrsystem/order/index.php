    ...
    ?>
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    <div class="d-xl-flex justify-content-between align-items-start">
                        <div class="d-sm-flex justify-content-xl-between align-items-center mb-2">
                            <h4 class="text-dark font-weight-bold mb-2">User Orders</h4>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="tab-content tab-transparent-content">
                                            ...
                                            <div class="card shadow p-3 mb-5 bg-white rounded"
                                                ...
                                                <a href="view_orders.php" style="text-decoration: none">
                                                    <div class="card-body text-center">
                                                        ...
                                                        <?php
                                $sql="select * from order_status where eoid='".$_SESSION['eid']."'";
                                ...
                                ?>
                                        ...
                                        <div class="col-xl-3 col-lg-3 col-sm-2 grid-margin stretch-card">
                                            <div class="card shadow p-3 mb-5 bg-white rounded"
                                                style="height:220px;box-sh">
                                                <a href="today_orders.php" style="text-decoration: none">
                                                    <div class="card-body text-center">
