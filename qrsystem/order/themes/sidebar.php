...
if(isset($_SESSION['ename']) && isset($_SESSION['eid']) && isset($_SESSION['eemail']) && isset($_SESSION['eimg']))
{
    ...
    <li class="nav-item nav-category">Orders</li>
        <li class="nav-item">
        <a class="nav-link" data-toggle="collapse" href="#ui-basic1333" aria-expanded="false"
            aria-controls="ui-basic">
                 <span class="icon-bg bg-light"><i class=""><img src="../../icon/order.svg" style="height:18px;width:18px;"></i></span>
            <span class="menu-title">User Orders</span>
        </a>
        <div class="collapse" id="ui-basic1333">
            <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="new_order.php">New Order</a></li>
                <li class="nav-item"> <a class="nav-link" href="view_orders.php">View Order</a></li>
    ...
    <a class="nav-link" data-toggle="collapse" href="#ui-basic13" aria-expanded="false"
        aria-controls="ui-basic">
             <span class="icon-bg bg-light"><i class=""><img src="../../icon/up.svg" style="height:18px;width:18px;"></i></span>
        <span class="menu-title">Order Status</span>
    </a>
    <div class="collapse" id="ui-basic13">
        <ul class="nav flex-column sub-menu">
            <li class="nav-item"> <a class="nav-link" href="pending_order.php">Pending Order</a></li>
            <li class="nav-item"> <a class="nav-link" href="view_orders.php">Complete Order</a></li>
        </ul>
    </div>
</li>
