...
?>
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="row">
                <?php
                $q2="select * from order_status where eoid='".$_SESSION['eid']."' and status='Order Preparing'";
                if($r2=mysqli_query($conn,$q2))
                {
                    while($n2=mysqli_fetch_assoc($r2))
                    {
                        ...
                        <div class="card">
                          <div class="card-body">
                          <h4 class="card-title"><font color="red">'.$n2['osid'].'</font> || <font color="green">'.$n2['stamp'].'</font></h4>
