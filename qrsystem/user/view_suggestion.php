...
<body>
    ...
    ?>
            ...
            if(isset($_SESSION['uname']) && isset($_SESSION['uid']) && isset($_SESSION['uemail']) && isset($_SESSION['uimg']))
            {
                $q1="select * from suggestion where id='".$_SESSION['uid']."'";
                if($r1=mysqli_query($conn,$q1))
                {
                    while($num=mysqli_fetch_assoc($r1))
                    {
                        ...
                        <div class="card">
                          <div class="card-body">
                            ...
                            <form class="forms-sample" method="post">
                              ...
                              if(!$num['img']=="")
                              {
                                echo '<button name="img" class="btn btn-primary mr-3"><a style="color:white" target="_blank" href="../../images/user/suggestion/'.$num['img'].'">Uploaded Document</a></button>';
                              }
                            echo '
                            </form>
                          </div>
