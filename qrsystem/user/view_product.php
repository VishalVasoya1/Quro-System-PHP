                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="product-nav-wrapper row">
                                        ...
                                        <div class="col-lg-8 col-md-7 product-filter-options">
                                            <ul class="account-user-info ml-auto">
                                                <li><a href="order_history.php" class="text-dark">My Orders</a></li>
                                    ...
                                    <div class="row product-item-wrapper">
                                        <?php
                    $q1="select * from products where pfinalstatus='1' and pstock!=0";
                        ...
                        <div class="card">
                          <div class="card-body">
                            <div class="action-holder">
                              <div class="sale-badge bg-success">Top</div>
