    ...
    ?>
            ...
            ?>
                    <div class="page-header">
                        <h3 class="page-title">Pending Complain</h3>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#">Complain</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Pending Complain</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="row">
            ...
            if(isset($_SESSION['ename']) && isset($_SESSION['eid']) && isset($_SESSION['eemail']) && isset($_SESSION['eimg']))
            {
                $q1="select * from complain where type='EMPLOYEE' and id='".$_SESSION['eid']."' and rstatus='0'";
                if($r1=mysqli_query($conn,$q1))
                {
                    while($num=mysqli_fetch_assoc($r1))
                    {
