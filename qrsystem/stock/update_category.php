...
if(isset($_SESSION['ename']) && isset($_SESSION['eid']) && isset($_SESSION['eemail']) && isset($_SESSION['eimg']))
{
    ...
    {
        $cname=$_POST['cname'];
        $q11="update category set cname='$cname',stamp=current_timestamp() where cid='$cid'";
...
if(isset($_SESSION['ename']) && isset($_SESSION['eid']) && isset($_SESSION['eemail']) && isset($_SESSION['eimg']))
{
    ...
    ?>
        ...
        if(isset($_SESSION['ename']) && isset($_SESSION['eid']) && isset($_SESSION['eemail']) && isset($_SESSION['eimg']))
        {
                        if(isset($_GET['cid']))
                        {
                            $q10="select * from category where cid='$cid'";
                            if($r10=mysqli_query($conn,$q10)){
                                while($num=mysqli_fetch_assoc($r10)){
                                    ...
                                    <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" id="cname" name="cname" value="'.$num['cname'].'" placeholder="Category Name" >
                                    </div>
