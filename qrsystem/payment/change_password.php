...
if(isset($_SESSION['ename']) && isset($_SESSION['eid']) && isset($_SESSION['eemail']) && isset($_SESSION['eimg']))
{
    if(isset($_POST['submit']))
    {
        ...
        $npass=$_POST['npass'];
        $ncpass=$_POST['ncpass'];
        $q2="select * from employee where eid='".$_SESSION['eid']."'";
        if($r2=mysqli_query($conn,$q2))
        {
            while($num1=mysqli_fetch_assoc($r2))
            {
                ...
                if($pass == $opass)
                {
                    if($ncpass == $npass)
                    {
                        $q3="update employee set epass='$npass' where eid='$eid'";
          ...
          <div class="row w-100">
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-transparent text-left p-5 text-center">
                <img src="../../images/employee/profile/<?php echo $_SESSION['eimg']; ?>" style="height:135px;width:135px;border-radius: 50%;" class="lock-profile-img" alt="img">
