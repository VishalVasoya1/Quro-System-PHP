                ...
                <div class="card px-2">
                  <div class="card-body">
                    <div class="container-fluid">
                      <h3 class="text-right my-5"><font color="black" size="3px">Invoice : <?php echo $fcode; ?></font><br><br></h3>
                      <hr>
                    </div>
                    ...
                    <div class="container-fluid mt-5 d-flex justify-content-center w-100">
                      <div class="table-responsive w-100">
                        <table class="table">
                          ...
                          <tbody>
                            <?php
                               $q4="select * from orders where cop='$fcode'";
                    ...
                    <div class="container-fluid w-100">
                      <a href="order_success.php?fcode=<?php echo $pcode; ?>" class="btn btn-sm btn-inverse-primary mr-2">Print</a>
                      <a href="index.php" class="btn btn-sm btn-inverse-danger mr-2">Home</a>
                    </div><br>
