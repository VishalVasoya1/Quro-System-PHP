...
if(isset($_SESSION['ename']) && isset($_SESSION['eid']) && isset($_SESSION['eemail']) && isset($_SESSION['eimg']))
{
    ...
    $q12="select * from orders where cop='$pcode'";
    ...
    $q1="select * from user_address where aid='$aid' ";
...
?>
            ...
            ?>
                    ...
                    <div class="row">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row product-item-wrapper">
                                        <?php
                                                $q11="select * from orders where cop='$pcode'";
                                                if($r11=mysqli_query($conn,$q11))
                                                {
                                                    ...
                                                    while($n11=mysqli_fetch_assoc($r11))
                                                    {
                                                      ...
                                                      if($r1=mysqli_query($conn,$q1))
                                                      {
                                                        ...
                                                        <div class="sale-badge bg-success">Order</div>
                                                    ...
                                                    <a href="view_product_detail.php?pid='.$n1['pid'].'" style="width:310px"> <img class="product_image" src="../../images/employee/products/'.$n1['ptitleimg'].'" alt="product image" height="240px"></a>
                                                        ...
                                                        if($n11['size']!="0" && $n11['pcolor']!="0")
                                                        {
                                                            echo ' <li><a href="#">'.$n11['size'].'</a></li>';
                                                        echo ' <li><a href="#">'.$n11['pcolor'].'</a></li>';
                                                        }
                                                        
                                                        echo '
                                                        
                                                        <p class="product-description product-title text-dark">Quantity: '.$n11['quantity'].'</p>
                                                        </ul>
                                                    </div>
                                                    </div>
                                                </div>';
                                    ...
                                    <div class="row">
                                        <div class="table-sorter-wrapper col-lg-12 table-responsive">
                                            <table id="sortable-table-1" class="table">
                                                ...
                                                <tbody><?php
                        $q13="select * from orders where cop='$pcode'";
                        if($r13=mysqli_query($conn,$q13))
                        {
                            while($num2=mysqli_fetch_assoc($r13))
                                {
                                  echo '<tr>
                                  <td>'.$num2['pid'].'</td>
                                  <td>'.$num2['price'].'</td>
                      ...
                      <a href="order_success.php?fcode=<?php echo $pcode; ?>" class="btn btn-sm btn-inverse-primary mr-2 float-right">View Invoice</a>
                      <a href="index.php" class="btn btn-sm btn-inverse-danger mr-2 float-right">Home</a>
                    </div><br>
                                        </div>
                                    </div>
                                </div>
