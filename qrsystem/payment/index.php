    ...
    ?>
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    <div class="d-xl-flex justify-content-between align-items-start">
                        <div class="d-sm-flex justify-content-xl-between align-items-center mb-2">
                            <h4 class="text-dark font-weight-bold mb-2">Collections</h4>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="tab-content tab-transparent-content">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-3 col-lg-3 col-sm-2 grid-margin stretch-card">
                                            <div class="card shadow p-3 mb-5 bg-white rounded"
                                                ...
                                                <a href="today_collection.php" style="text-decoration: none">
                                                    <div class="card-body text-center">
                                                        <h5 class="mb-2 text-dark font-weight-bold">Today Payments
                                                        </h5>
                              <?php
                              $c=0;
                              $q2="select * from orders where eid='".$_SESSION['eid']."'";
                              ...
                              ?>
                                                        <h2 class="mb-4 text-dark font-weight-bold"><?php echo $c;?>
                                                        </h2>
                                                        <img src="../../images/employee/icon/todaycollection.svg"
                                                            height=70 width=150 />
                                                    </div>
                                                </a>
                                            </div>
                                        ...
                                        <div class="col-xl-3 col-lg-3 col-sm-2 grid-margin stretch-card">
                                            <div class="card shadow p-3 mb-5 bg-white rounded"
                                                style="height:220px;box-sh">
                                                <a href="total_collection.php" style="text-decoration: none">
                                                    <div class="card-body text-center">
                                                        <h5 class="mb-2 text-dark font-weight-bold">Total Payments
                                                        </h5>
                                                        <?php
                              $c=0;
                              $q2="select * from orders where eid='".$_SESSION['eid']."'";
                              ...
                              ?>
                                                        ...
                                                        <img src="../../images/employee/icon/totalcollection.svg"
                                                            height=70 width=140 />
                                        ...
                                        <div class="tab-pane fade show active" id="business-1" role="tabpanel"
                                            ...
                                            <div class="row">
                                                <div class="col-xl-3 col-lg-3 col-sm-2 grid-margin stretch-card">
                                                    <div class="card shadow p-3 mb-5 bg-white rounded"
                                                        style="height:220px;box-sh">
                                                        <a href="view_suggestion.php" style="text-decoration: none">
                                                            <div class="card-body text-center">
